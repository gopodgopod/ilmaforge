...
function navigate(sectionId) {
  ...
  if (sectionId === 'about')   history.pushState(null, '', '/about');
...
(function handlePath() {
  ...
  if (path === '/about')   { navigate('about');   return; }
